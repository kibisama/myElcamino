...
const FileSvg = ({ color1, color2, ...props }) => {
  const { palette } = useTheme();
  return (
    <svg viewBox="-4 0 64 64" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        ...
        fillRule="evenodd"
        clipRule="evenodd"
        fill={color1 || palette.secondary.light}
      />
      {/* <path
      ...
      <g fillRule="evenodd" clipRule="evenodd">
        <path
          ...
          fill={color2 || palette.secondary.dark}
        />
        <path
